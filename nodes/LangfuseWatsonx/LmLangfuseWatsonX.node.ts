...
import { N8nLlmTracing } from '../Watsonx/depedancies/N8nLlmTracing';
import { N8nLangfuseHandler } from './dependancies/N8nLangfuseHandler';
import { makeN8nLlmFailedAttemptHandler } from '../Watsonx/depedancies/n8nLlmFailedAttemptHandler';
...
export class LmLangfuseWatsonX implements INodeType {
	description: INodeTypeDescription = {
		displayName: 'WatsonX Langfuse LLM',
		name: 'lmLangfuseWatsonX',
		icon: 'file:IBM_watsonx_logo.svg',
		group: ['transform'],
		version: 1.0,
		description: 'For advanced usage with an AI chain',
		defaults: { name: 'WatsonX Langfuse LLM' },
...
module.exports = { LmLangfuseWatsonX };
